...
- Any decision only the human can make: scope, product trade-offs, naming they care about, or anything ambiguous in the request. Use the tool's structured ask-the-human mechanism (e.g. `AskUserQuestion` on Claude Code) for these.
